...
SECRET_KEY = 'django-insecure-7a@u52fdu+ba#d-o^)!wp3yj6_e^cz69_@#scn&+#e#f6lheeo'
...
# Secure cookies (already set, but documented here for clarity)
SESSION_COOKIE_SECURE = True  # Session cookies only sent over HTTPS
CSRF_COOKIE_SECURE = True     # CSRF cookies only sent over HTTPS

# Security headers (already set, but documented here for clarity)
X_FRAME_OPTIONS = 'DENY'  # Prevent clickjacking
SECURE_CONTENT_TYPE_NOSNIFF = True  # Prevent MIME type sniffing
SECURE_BROWSER_XSS_FILTER = True    # Enable browser XSS filter

# Proxy SSL header (for when Django is behind a proxy/load balancer)
...
# Custom user model for checker compatibility
